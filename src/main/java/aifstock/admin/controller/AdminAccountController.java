package aifstock.admin.controller;
...
import aifstock.admin.service.AdminAccountService;
...
public class AdminAccountController {
     ...
     */
    @GetMapping("/page")
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).ADMIN_ACCOUNT_READ)")
     ...
     */
    @PostMapping
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).ADMIN_ACCOUNT_CREATE)")
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).ADMIN_ACCOUNT_UPDATE)")
     ...
     */
    @DeleteMapping("/{id}")
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).ADMIN_ACCOUNT_DELETE)")
