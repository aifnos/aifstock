...
import aifstock.admin.dto.RoleMenuAssignRequest;
import aifstock.admin.dto.RoleMenuPermissionAssignRequest;
import aifstock.admin.service.RoleMenuPermissionService;
...
public class RoleMenuPermissionController {
    ...
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).ROLE_ACCESS_UPDATE)")
