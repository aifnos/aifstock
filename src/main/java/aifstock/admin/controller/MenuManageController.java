...
import aifstock.admin.service.MenuManageService;
...
public class MenuManageController {
     ...
     */
    @GetMapping
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).MENU_READ)")
     ...
     */
    @PostMapping
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).MENU_CREATE)")
     ...
     */
    @PutMapping("/{id}")
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).MENU_UPDATE)")
     ...
     */
    @DeleteMapping("/{id}")
    @PreAuthorize("@rbacAuthority.hasPermission(T(aifstock.common.security.AdminPermission).MENU_DELETE)")
